 ...
 * @author mello
 */
public class TelaExcluirOpções extends javax.swing.JFrame {

    private Conexao conexao;
    private Connection conn;
    private Usuario usuariologado;

    public TelaExcluirOpções(Usuario usuario) {
        initComponents();
        conexao = new Conexao();
    ...
    private void initComponents() {
        ...
        lblTexto.setText("Qual deseja Excluir");

        btnExcluirFornecedor.setBackground(new java.awt.Color(102, 51, 255));
        btnExcluirFornecedor.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnExcluirFornecedor.setForeground(new java.awt.Color(255, 255, 255));
        btnExcluirFornecedor.setText("Fornecedor");
        ...
        btnExcluirProduto.setBackground(new java.awt.Color(102, 51, 255));
        ...
        btnExcluirProduto.setText("Produto");
    ...
    private void btnExcluirProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirProdutoActionPerformed
        new TelaExcluirProduto(usuariologado).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaExcluirOpções.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
             //   new TelaExcluirOpções().setVisible(true);
            }
        });
    }
